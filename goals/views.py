...
from .serializers import GoalCategorySerializer, CommentSerializer, CommentCreateSerializer, GoalSerializer,\
    GoalCreateSerializer, GoalCategoryCreateSerializer, BoardSerializer, BoardCreateSerializer, BoardListSerializer
